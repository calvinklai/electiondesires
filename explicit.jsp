...
{{"rate1"},{"ncols","3"},{"options","Arizona Cardinals","Atlanta Falcons","Baltimore Ravens","Buffalo Bills","Carolina Panthers","Chicago Bears",
"Cincinnati Bengals","Cleveland Browns","Dallas Cowboys","Denver Broncos","Detroit Lions","Green Bay Packers","Houston Texans",
"Indianapolis Colts","Jacksonville Jaguars","Kansas City Chiefs","Miami Dolphins","Minnesota Vikings","New England Patriots","New Orleans Saints",
"New York Giants","New York Jets","Oakland Raiders","Philadelphia Eagles","Pittsburgh Steelers","San Diego Chargers","San Francisco 49ers",
"Seattle Seahawks","St. Louis Rams","Tampa Bay Buccaneers","Tennessee Titans","Washington Redskins","I don't have a favorite team"}},

{{"rate2"},{"options","I would be much happier if the Seattle Seahawks won", "I would be moderately happier if the Seattle Seahawks won","I would be somewhat happier if the Seattle Seahawks won","It does not matter to me which team won the game","I would be somewhat happier if the Denver Broncos won","I would be moderately happier if the Denver Broncos won","I would be much happier if the Denver Broncos won"}},
{{"rate3"},{"options","Extremely closely","Very closely","Moderately closely","Somewhat closely","Not very closely","Not at all closely"}},
{{"rate5"},{"options","Extremely knowledgeable","Very knowledgeable","Moderately knowledgeable","Somewhat knowledgeable","Slightly knowledgeable","Not at all knowledgeable"}},
{{"rate6"},{"options","Definitely the Denver Broncos","Probably the Denver Broncos","Maybe the Denver Broncos","I do not know","Maybe the Seattle Seahawks","Probably the Seattle Seahawks", "Definitely the Seattle Seahawks"}},
{{"rate7"},{"options","I am a strong fan of the Seattle Seahawks","I am a moderate fan of the Seattle Seahawks","I am a slight fan of the Seattle Seahawks","I would not call myself a fan of the Seattle Seahawks"}},
{{"rate8"},{"options","I am a strong fan of the Denver Broncos","I am a moderate fan of the Denver Broncos","I am a slight fan of the Denver Broncos","I would not call myself a fan of the Denver Broncos"}},
{{"rate9"},{"options","I strongly prefer the Seattle Seahawks to the Denver Broncos.","I moderately prefer the Seattle Seahawks to the Denver Broncos.","I slightly prefer the Seattle Seahawks to the Denver Broncos.","I like the Seattle Seahawks and the Denver Broncos equally.","I slightly prefer the Denver Broncos to the Seattle Seahawks.","I moderately prefer the Denver Broncos to the Seattle Seahawks.","I strongly prefer the Denver Broncos to the Seattle Seahawks."}},
{{"rate10"},{"options","Very warm", "Moderately warm", "Slightly warm",  "Neither warm nor cold", "Slightly cold", "Moderately cold", "Very cold"}},
{{"rate11"},{"options","Tom Brady", "Colin Kaepernick", "Peyton Manning", "Russell Wilson", "I do not know"}},
{{"rate12"},{"options","LeGarrette Blount", "Frank Gore", "Marshawn Lynch", "Knowshon Moreno", "I do not know"}},
{{"rate13"},{"options","Bill Belichick", "Pete Carroll", "John Fox", "Jim Harbaugh", "I do not know"}},
};
            

String[][][] basic =
{
{{"basic"}, {"nelem","8"},{"musthave","0"},{"group","0"},{"gminmax","8.8"},{"gplace","0"},{"gorder","0"},{"gsequence","fixed"},{"prefix","<br/>Please respond to the following question.<br/>"}},
{{"favteam"},{"choices","rate1"},{"stem","What is your favorite football team?"}},
{{"closefollow"},{"choices","rate3"},{"stem","How closely do you follow the National Football League (NFL)?"}},
{{"knowledgeable"},{"choices","rate5"},{"stem","How knowledgeable are you about the National Football League (NFL)?"}},
{{"superbowlpref"},{"choices","rate2"},{"stem","In a game between the Seattle Seahawks and the Denver Broncos, which of the following best reflects your feelings about the Seattle Seahawks and the Denver Broncos?"}},
{{"expectwin"},{"choices","rate6"},{"stem","Who do you think will win this year's Super Bowl?"}},
{{"fanstrength_seahawks"},{"choices","rate7"},{"stem","How strong of a fan are you of the Seattle Seahawks?"}},
{{"fanstrength_broncos"},{"choices","rate8"},{"stem","How strong of a fan are you of the Denver Broncos?"}},
{{"att"},{"choices","rate9"},{"stem","Which statement best describes you?"}},
};                 

String[][][] knowledge =
{
{{"knowledge"}, {"nelem","6"},{"musthave","0"},{"group","0"},{"gminmax","6.6"},{"gplace","0"},{"gorder","0"},{"gsequence","random"}},
{{"knowledge_qb_seahawks"},{"choices","rate11"},{"stem","Who is the starting quarterback of the Seattle Seahawks?"}},
{{"knowledge_qb_broncos"},{"choices","rate11"},{"stem","Who is the starting quarterback of the Denver Broncos?"}},
{{"knowledge_rb_seahawks"},{"choices","rate12"},{"stem","Who is the starting running back of the Seattle Seahawks?"}},
{{"knowledge_rb_broncos"},{"choices","rate12"},{"stem","Who is the starting running back of the Denver Broncos?"}},
{{"knowledge_coach_seahawks"},{"choices","rate13"},{"stem","Who is the head coach of the Seattle Seahawks?"}},
{{"knowledge_coach_broncos"},{"choices","rate13"},{"stem","Who is the head coach of the Denver Broncos?"}},
};
...
<script language="JavaScript" type="text/javascript" src="/implicit/common/en-us/js/task.js"></script>
   ...
   <style type="text/css">
    ...
    <title>Survey: Section PoI</title>
...
// #BDEDFF light blue
 ...
 // var minselect = js_minselect[curitem];
  ...
  var curdisplay='<table width="70%" align=center><tr><td><font color="#AAAAAA"><span  class=small><b>Section PoI: '+(curitem+1)+'/'+js_nitem+' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  </b></span></font><br /><span  class='+preclass+'>'+js_prefix[curitem]+'</span><br/><span class=big style="background-color: #FFFFCC">'+js_stem[curitem]+'</span><br/><br/></td></tr></table> <table width="70%" align=center cellpadding="2">';
