...
String[][][] basic =
{
{{"basic"}, {"nelem","1"},{"musthave","0"},{"group","0"},{"gminmax","1.1"},{"gplace","0"},{"gorder","0"},{"gsequence","fixed"},{"prefix","<br/>Please respond to the following question.<br/>"}},
{{"knowledge_win_t2"},{"choices","rate6"},{"stem","Who do you think won this year's Super Bowl?"}},
};                 
